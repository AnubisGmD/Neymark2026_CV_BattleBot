...
В репозитории также доступна финальная прошивка для модуля управления роботом в файле [esp32.ino](esp32.ino).
Прошивка решает следующие транспортные задачи:
* Создание защищенной Wi-Fi точки доступа (`NEYMARK_01` / `neymark123`).
